...
WHERE schemaname = current_schema()
  AND indexname IN (
    ...
    'idx_tickets_assigned_status_created_at',
    'idx_tickets_department_status_created_at',
    'idx_tickets_location_created_at',
    'idx_ticket_messages_ticket_created_at',
    'idx_notifications_unread_created_at'
  )
